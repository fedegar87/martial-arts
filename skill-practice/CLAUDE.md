...
- Visual identity: dark/gold FESK theme applicato via `globals.css`; non usare UI chiare o palette fuori tema senza aggiornare `plan/reference/visual-identity-plan.md`.
