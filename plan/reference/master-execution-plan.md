...
| Fase 1 | `plan/reference/design/visual-identity-plan.md`, `plan/completed/2026-04-25-progress-tab-plan.md` se si completa parity |
...
| Fase 5 | `plan/reference/domain/curriculum-mapping-fesk.md`, eventualmente rigenerare seed |
| Fase 6 | `plan/reference/business/positioning-analysis.md`, decisione Scenario B |
