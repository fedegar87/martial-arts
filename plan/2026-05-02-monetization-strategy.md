...
|---|---|
| "FESK = Federazione Europea Scuola Kung Fu" | Inventato. Il codebase ([curriculum-mapping-fesk.md:5](reference/domain/curriculum-mapping-fesk.md#L5)) cita solo il dominio `feskfongttai.it`. L'espansione corretta non è confermata. **Non usare nessuna espansione finché non verificata.** |
