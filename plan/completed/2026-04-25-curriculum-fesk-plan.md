...
> **Fonte canonica risolta:** `plan/reference/domain/curriculum-mapping-fesk.md` contiene la mappatura validata dal fondatore. La migration `0004_seed_fesk.sql` è generata da `skill-practice/scripts/generate-fesk-seed.mjs`.
